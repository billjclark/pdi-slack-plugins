...
public class SlackStepMetaTest {
  ...
  public void testGetStepData() {
    SlackStepMeta m = new SlackStepMeta();
    assertEquals( SlackStepData.class, m.getStepData().getClass() );
  }
  ...
  public void testStepAnnotations() {
    ...
    Step stepAnnotation = SlackStepMeta.class.getAnnotation( Step.class );
    ...
    assertEquals( SlackStepMeta.class.getPackage().getName(), stepAnnotation.i18nPackageName() );
    ...
    InjectionSupported injectSupportAnnotation = SlackStepMeta.class.getAnnotation( InjectionSupported.class );
    ...
    for ( Field field : SlackStepMeta.class.getDeclaredFields() ) {
      if ( field.isAnnotationPresent( Injection.class ) || field.isAnnotationPresent( InjectionDeep.class ) ) {
        hasInjection = true;
      }
    }
    for ( Method method : SlackStepMeta.class.getDeclaredMethods() ) {
  ...
  public void testLoadSave() throws KettleException {
     ...
     */
    LoadSaveTester<SlackStepMeta> tester =
      new LoadSaveTester<SlackStepMeta>( SlackStepMeta.class, attributes );
