...
public class SlackStepMeta extends BaseStepMeta implements StepMetaInterface {
   ...
   */
  private static final Class<?> PKG = org.pentaho.di.sdk.marketplace.steps.slack.SlackStepMeta.class; // for i18n purposes
  ...
  public StepDialogInterface getDialog( Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
    return new SlackStepDialog( shell, meta, transMeta, name );
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
      Trans disp ) {
    return new SlackStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
  }
